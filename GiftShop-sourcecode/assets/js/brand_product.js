...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('brand_name').textContent = brand;
  titleElement.textContent = brand; 

  displayProductsByBrand(brand, 'listBrandProduct');
});

function getProductsByBrand(_brand) {
  return window.listProducts.filter(o => o.brand === _brand);
}

function displayProductsByBrand(brand, targetId) {
